...
class World(ShowBase):
    def __init__(self):
        ...
        self.accept("arrow_up", self._turn, [pengaturan.POS_Y])
        self.accept("arrow_down", self._turn, [pengaturan.NEG_Y])
        self.accept("arrow_left", self._turn, [pengaturan.NEG_X])
        self.accept("arrow_right", self._turn, [pengaturan.POS_X])
        self.accept("space", self._tooggle_pause)
        self.accept("r", self._restart)

        self.period = pengaturan.PERIOD
        self.pause = True
    ...
    def _update_snake(self):
        ...
        for i in range(len(self._snake.body)):
            ...
            brick.setPos(point.real, pengaturan.SPRITE_POS, point.imag)
    ...
    def _update_dot(self):
        ...
        if (x, y) != self._snake.dot:
            self._dot.setPos(
                self._snake.dot.real, pengaturan.SPRITE_POS, self._snake.dot.imag)
